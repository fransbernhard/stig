export const AQI_LEVELS = [
  { max: 20,  label: 'Good',           color: '#4ade80', bg: '#f0fdf4', text: '#166534' },
  { max: 40,  label: 'Fair',           color: '#a3e635', bg: '#f7fee7', text: '#3f6212' },
  { max: 60,  label: 'Moderate',       color: '#facc15', bg: '#fefce8', text: '#854d0e' },
  { max: 80,  label: 'Poor',           color: '#fb923c', bg: '#fff7ed', text: '#9a3412' },
  { max: 100, label: 'Very Poor',      color: '#f87171', bg: '#fef2f2', text: '#991b1b' },
  { max: Infinity, label: 'Extremely Poor', color: '#c084fc', bg: '#faf5ff', text: '#6b21a8' },
]
